...
def defence(char_name: str, char_class: str) -> str:
    ...
    :param char_name: Имя персонажа.
    :param char_class: Класс персонажа ('warrior', 'mage', или 'healer').
    :return: Строка с результатом защиты.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    ...
    :param char_name: Имя персонажа.
    :param char_class: Класс персонажа ('warrior', 'mage', или 'healer').
    :return: Строка с результатом специального действия.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    ...
    :param char_name: Имя персонажа.
    :param char_class: Класс персонажа ('warrior', 'mage', или 'healer').
    :return: Строка с результатами тренировки.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    ...
    :return: Класс персонажа ('warrior', 'mage', или 'healer').
    """
    approve_choice: str = ''
    char_class: str = ''
...
def main() -> None:
    ...
    Организует выбор персонажа и тренировку.
